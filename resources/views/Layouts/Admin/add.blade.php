        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            <div class="mt-4 mx-4">
                <form class="mt-8 space-y-6 p-7 rounded-md bg-white dark:bg-orange-400 text-black dark:text-white"
                    ...
                    <div>
                        <button type="submit"
                            class="block w-full text-white bg-orange-400 hover:bg-orange-400 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-orange-400 dark:hover:bg-orange-500 focus:outline-none dark:focus:ring-purple-800 p-4 transition hover:scale-105">Add
                        </button>
                    </div>
